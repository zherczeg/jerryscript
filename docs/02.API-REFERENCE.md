...
static jerry_value_t module_promise;
                 ...
                 void *user_p) /**< user data */
{
  ...
  module_promise = jerry_create_promise ();
...
main (void)
{
  ...
  const jerry_char_t script[] = "import('b.mjs').then(\n"
  ...
  /* The application resolves both the module and the promise. */
  const jerry_char_t module_script[] = "export var a = 5";
  const jerry_char_t module_resource[] = "dir/my_module.js";
  ...
  jerry_value_t namespace_value = jerry_module_get_namespace (module_value);
  jerry_release_value (jerry_resolve_or_reject_promise (module_promise, namespace_value, true));
