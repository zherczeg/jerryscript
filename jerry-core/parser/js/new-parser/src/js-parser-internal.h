...
typedef enum
{
  ...
  PARSER_NO_END_LABEL = (1u << 15),           /**< return instruction must be inserted
  ...
  PARSER_CLASS_CONSTRUCTOR = (1u << 20),      /**< a class constructor is parsed (this value must be kept in
                                               *   in sync with PARSER_CLASS_PARSE_OPTS_OFFSET) */
...
void parser_free_local (void *ptr);
...
void parser_emit_cbc_push_number (parser_context_t *context_p, int is_negative_number);
...
int lexer_check_next_character (parser_context_t *context_p, uint8_t character);
#ifndef CONFIG_DISABLE_ES2015_CLASS
...
void lexer_scan_identifier (parser_context_t *context_p, int property_name);
...
int lexer_construct_number_object (parser_context_t *context_p, int is_expr, int is_negative_number);
...
void lexer_construct_regexp_object (parser_context_t *context_p, int parse_only);
int lexer_compare_identifier_to_current (parser_context_t *context_p, const lexer_lit_location_t *right_ident_p);
int lexer_compare_raw_identifier_to_current (parser_context_t *context_p, const char *right_ident_p,
...
#ifndef CONFIG_DISABLE_ES2015_CLASS
void parser_parse_class (parser_context_t *context_p, int is_statement);
void parser_parse_super_class_context_start (parser_context_t *context_p);
void parser_parse_super_class_context_end (parser_context_t *context_p, int is_statement);
#endif /* !CONFIG_DISABLE_ES2015_CLASS */
...
cbc_compiled_code_t *parser_parse_function (parser_context_t *context_p, uint32_t status_flags);
#ifndef CONFIG_DISABLE_ES2015_ARROW_FUNCTION
cbc_compiled_code_t *parser_parse_arrow_function (parser_context_t *context_p, uint32_t status_flags);
#endif /* !CONFIG_DISABLE_ES2015_ARROW_FUNCTION */
